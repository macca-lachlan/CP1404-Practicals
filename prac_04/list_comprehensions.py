...
# list comprehension that converts string entities into int entities
numbers = [int(number) for number in almost_numbers]
print(numbers)


# list comprehension that convert all characters in full_names in lowercase format
lowercase_full_names = [str.lower(full_name) for full_name in full_names]
